...
export default function Footer() {
    ...
    return (
        <footer className="footer">
            ...
            <div className="containerg-footer">
                <div className="container-footer">

                    <div className="logo-footer">
                        <h2>Pacific <span>Ocean</span></h2>
                        <p>{t("footer.slogan")}</p>
                    ...
                    <div className="container-inicio-page">
                        <div className="text-inicio-footer">
                            <p>Pagina de inicio de PacificOcean</p>
                            <ul>
                            ...
                            <li><Link activeClass="active" to="labor" spy={true} smooth={true} offset={50} duration={500} >{t("nav.job")}</Link></li>
                                ...
                                <li><Link activeClass="active" to="ayuda" spy={true} smooth={true} offset={50} duration={500}>{t("nav.donate")}</Link></li>
                    ...
                    <div className="consultas-footer">
                        <p>{t("footer.help.title")}</p>
                            <ul>
                                <li>{t("footer.help.element1")}</li>
                                <li>{t("footer.help.element2")}</li>
                                <li>{t("footer.help.element3")}</li>
                                <li>{t("footer.help.element4")}</li>
                            </ul>
                        </div>


                    <div className="donar-social"> {/* SOCIAL MNEDIA Y BOTYON DONAR DE FOOTER */}
                        ...
                        <div className="ayuda-donar">
                            <p>
                                <Link activeClass="active" to="donar" spy={true} smooth={true} offset={50} duration={500}>{t("donate.btndonate")}</Link>
                            </p>
                        </div>
